...
struct SdDisk_t *sddisk_init( );

/* Get a pointer to IOMAN, which can be used for all FreeRTOS+FAT functions */
FF_IOManager_t *sddisk_ioman( struct SdDisk_t *pDisk );

/* Release all resources */
BaseType_t sddisk_delete( struct SdDisk_t *pDisk );

/* Show some partition information */
BaseType_t sddisk_show_partition( struct SdDisk_t *pDisk );

/* Flush changes from the driver's buf to disk */
void sddisk_flush( struct SdDisk_t *pDisk );
